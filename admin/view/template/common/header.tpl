...
<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
	<head>
		...
		<link type="text/css" href="view/stylesheet/wh.css" rel="stylesheet" media="screen" />
			...
			<header id="header" class="navbar navbar-static-top">
				...
				<?php if ($logged) { ?>
					<ul class="nav pull-right">
						...
						<?php }else{ ?>
						<li><a href="<?php echo $stores[0]['href']; ?>" target="_blank" title="<?php echo $store['name']; ?>" ><i class="fa fa-home fa-lg"></i></a></li>
						<?php } ?>
