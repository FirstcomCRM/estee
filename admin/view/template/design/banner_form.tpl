              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <td width="120px" class="text-center"><?php echo $entry_image; ?></td>
                    <td width="120px" class="text-center">Mobile <?php echo $entry_image; ?></td>
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <select name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][color_theme]" class="form-control" >
                        <option value="light_image" <?php echo ($banner_image['color_theme']=="light_image")?'selected':''; ?> > Light </option>
...
function addImage(language_id) {
    ...
    html += '  <td class="text-left"><input type="text" name="banner_image[' + language_id + '][' + image_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" /><hr/><p>Description</p><textarea rows="3" class="form-control" name="banner_image[' + language_id + ']['+ image_row +'][description]" ></textarea></td>';
	html += '  <td class="text-left"><p>Label</p><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link_text]" value="" placeholder="Label" class="form-control" /><p>Link</p><input type="text" name="banner_image[' + language_id + '][' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';	
	html += '  <td class="text-center"><a href="" id="thumb-image' + image_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][image]" value="" id="input-image' + image_row + '" /><hr/><select name="banner_image[' + language_id + '][' + image_row + '][color_theme]" class="form-control" ><option value="light_image" >Light</option><option value="dark_image" >Dark</option></select></td>';
  html += '  <td class="text-center"><a href="" id="thumb-mobile-image' + image_row + '" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="banner_image[' + language_id + '][' + image_row + '][mobile_image]" value="" id="input-mobile-image' + image_row + '" /><hr/><select name="banner_image[' + language_id + '][' + image_row + '][mobile_color_theme]" class="form-control" ><option value="light_image" >Light</option><option value="dark_image" >Dark</option></select></td>';
