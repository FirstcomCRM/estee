	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				...
				<a id="import" class="btn btn-success disabled" disabled="disabled"  data-loading-text="<?php echo $text_loading; ?>" ><i class="fa fa-file-excel-o" aria-hidden="true"></i> Upload</a>
