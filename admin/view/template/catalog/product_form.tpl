...
<div id="content">
								...
								<table id="images" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											...
											<td class="text-left"><?= $entry_domain; ?></td>
											<td class="text-left"><?= $entry_image_url; ?></td>
										...
										<?php foreach ($product_images as $product_image) { ?>
											<tr id="image-row<?= $image_row; ?>">
												...
												*/ ?>
												...
												<td class="text-right"><input type="text" name="product_image[<?= $image_row; ?>][domain]" value="<?= $product_image['domain']; ?>" placeholder="<?= $entry_domain; ?>" class="form-control" /></td>
												<td class="text-right"><input type="text" name="product_image[<?= $image_row; ?>][image_url]" value="<?= $product_image['image_url']; ?>"  placeholder="<?= $entry_image_url; ?>" class="form-control" /></td>
	...
	<script type="text/javascript"><!--
		...
		function addImage() {
			...
			html += '  <td class="text-left"><a class="img-thumbnail"><img src="<?= $placeholder; ?>" alt="" title="" data-placeholder="<?= $placeholder; ?>" /></a><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
			html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][domain]" value="" placeholder="<?= $entry_domain; ?>" class="form-control" /></td>';
			html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][image_url]" value="" placeholder="<?= $entry_image_url; ?>" class="form-control" /></td>';
