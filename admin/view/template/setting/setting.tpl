          ...
          <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-social">
                  <fieldset>
                    ...
                    <div class="">
                      <p>Icon code can be obtain <a href="http://fontawesome.io/icons/" target="_blank" ><u>here</u></a>, under <b></b>Brand Icons</b></p>
                      ...
                      <table id="social-media" class="table table-striped table-bordered table-hover">
                        <thead>
                          <tr>
						    ...
						    <td class="text-left"><span title="Optional if Icon is available" data-toggle="tooltip">Code Icon</span></td>
