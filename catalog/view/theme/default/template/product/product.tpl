            ...
            <div class="form-group">
              ...
              <?php if($quantityincrementdecrement_status){ ?> 
                <div class="input-group">
                    ...
                    <input type="text" name="quantity" class="form-control input-number integer" id="input-quantity" value="<?php echo $minimum; ?>" >
                    <span class="input-group-btn">
              ...
              <?php if($download){ ?>
                <a href="<?= $download; ?>" target="_blank" class="btn btn-primary btn-lg btn-block" ><?= $button_download; ?></a>
              <?php } ?>
