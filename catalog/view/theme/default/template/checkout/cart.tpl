...
<div class="container">
  ...
  <div class="row">
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="cartSummary" >
              ...
              <tr>
                ...
                <td class="text-left">
                  <div class="input-group btn-block" style="max-width: 200px;" >
                    ...
                    <div class="input-group" id="cart-item-<?php echo $product['cart_id']; ?>" >
                      <span class="input-group-btn">
                        <button type="button" data-loading="-" class="btn btn-default btn-number" data-type="minus" onclick="descrement($(this).parent().parent()); refreshCart(this);" >
                          <span class="glyphicon glyphicon-minus"></span>
                        </button>
                      </span>
                      <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" class="form-control input-number integer text-center update-cart" value="<?php echo $product['quantity']; ?>" onblur="refreshCart(this);" >
                      <span class="input-group-btn">
                        <button type="button" data-loading="+" class="btn btn-default btn-number" data-type="plus" onclick="increment($(this).parent().parent());  refreshCart(this);">
              ...
              <tr>
                ...
                <td class="text-left">
                  <div class="input-group btn-block" style="max-width: 200px;">
                    ...
                    <span class="input-group-btn">
                      <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick="voucher.remove('<?php echo $voucher['key']; ?>');">
                        <i class="fa fa-times-circle"></i>
                      </button>
                    </span>
                  </div>
  ...
  function refreshCart(ele){
    ...
    $.ajax({
      ...
      success: function(html){
        ...
        if(alert.length){
          $(".breadcrumb").after("<div class='alert alert-success'>" + alert.html() + "</div>");
        }
